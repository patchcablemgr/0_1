...
(function($){
    ...
    function makePathSelector(input, pluginOptions, optionsAccesor) {
        ...
        $(pathSelector).find(".level, .arrowButton, .contextMenu a").on("mouseover", "", function(){$(this).addClass("ui-state-hover")});
        $(pathSelector).find(".level, .arrowButton, .contextMenu a").on("mouseout", "", function(){$(this).removeClass("ui-state-hover")});
        $(pathSelector).find("a").on("mousedown", "", function(){$(this).addClass("ui-state-active")});
        $(pathSelector).find("a").on("mouseup", "", function(){$(this).removeClass("ui-state-active")});
            ...
            if(pathSelectorData.cache[value]){
                ...
                if(isString(pathSelectorData.optionsAccesor)){
                    $.getJSON(pathSelectorData.optionsAccesor, {
                    		objectID: $('#trunkedToObjectID').val(),
                            value: value
                        }, function(options){
                            menuOptions=options;
        ...
        $(pathSelector).find(".level").on("click", function(){
        ...
        contextMenu: function(o, callback) {
            ...
            $(this).each( function() {
                ...
                $(this).click( function(e) {
                        ...
                        menu.css({
                            top: srcElement.position().top + srcElement.parent().outerHeight(),
